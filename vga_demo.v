...
module vga_demo(CLOCK_50, SW, KEY, LEDR, PS2_CLK, PS2_DAT, HEX5, HEX4, HEX3, HEX2, HEX1, HEX0,
	...
	*/
    ...
    object O1 (Resetn, CLOCK_50, KEY1, step, O1_dir, O1_x, O1_y, 
	 ...
	 blockObject happy (Resetn, CLOCK_50, KEY3, Block_x, Block_y, Block_color, Block_write, Block_done, Block_ini_x, Block_ini_y);
    ...
    assign MUX_x = KEY3 ? Block_x : O1_x ;
    assign MUX_y = KEY3 ? Block_y : O1_y ;
    assign MUX_color = KEY3 ? Block_color : O1_color;
    assign MUX_write = KEY3 ? Block_write : O1_write;
